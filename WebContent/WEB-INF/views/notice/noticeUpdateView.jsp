	...
	<div class="outer">
		<article class="article_outer">
			...
			<div id="insertNoticeArea">
 				<form id="insertNotice" action="${ contextPath }/notice/update" method="post">
 					<input type="hidden" name="nno" value="${ notice.nno }">
					<div class="titleArea">
						<h4>제목</h4>
						<input type="text" name="title" value="${ notice.nTitle }" required>
					</div>
					<h4>내용</h4>
					<div class="textarea">
						<textarea id="summernote" name="editordata">${ notice.nContent }</textarea>
					</div>
					<div class="btn_Area">
